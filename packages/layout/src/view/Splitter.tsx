...
export class Splitter extends React.Component<ISplitterProps, any> {
    ...
    onMouseDown = (event: Event | React.MouseEvent<HTMLDivElement, MouseEvent> | React.TouchEvent<HTMLDivElement>) => {
        ...
        this.outlineDiv.className = this.props.layout.getClassName("flexlayout-splitter-drag");
    ...
    render() {
        ...
        return  <div
            ...
            className={cm(`flexlayout-splitter ${this.props.node.getOrientation() === Orientation.HORZ ? "splitter-horizontal" : "splitter-vertical"}`)}/>;
    }
}
