...
export class BorderTabSet extends React.Component<IBorderTabSetProps, any> {
    ...
    render() {
        ...
        let borderClasses = cm("flexlayout-border-" + border.getLocation().getName());
        ...
        const toolbar = <div
            ...
            className={cm("flexlayout-border-toolbar-" + border.getLocation().getName())}>
            {buttons}
        </div>;
        ...
        return <div
            ...
            <div className={cm("flexlayout-border-inner-" + border.getLocation().getName())}>
                {tabs}
            </div>
            {toolbar}
        </div>;
