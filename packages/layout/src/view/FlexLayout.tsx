 ...
 */
export class FlexLayout extends React.Component<IFlexLayoutProps, any> {
  ...
  render() {
    ...
    return (
      <div
        ...
        className={this.getClassName("flexlayout-layout")}
    ...
    for (const border of borderSet.getBorders()) {
      if (border.isShowing()) {
        borderComponents.push(
          <BorderTabSet
            key={"border-" + border.getLocation().getName()}
            border={border}
            layout={this}
          />
        );
  ...
  addTabWithDragAndDropIndirect(
    ...
    this.dragDiv.className = this.getClassName("flexlayout-drag-rect");
  ...
  onDragStart = () => {
    ...
    this.outlineDiv.className = this.getClassName("flexlayout-outline-rect");
  ...
  showEdges(rootdiv: HTMLElement) {
    if (this.model!.isEnableEdgeDock()) {
      ...
      this.edgeTopDiv.className = this.getClassName("flexlayout-edge-rect");
      ...
      this.edgeLeftDiv.className = this.getClassName("flexlayout-edge-rect");
      ...
      this.edgeBottomDiv.className = this.getClassName("flexlayout-edge-rect");
      ...
      this.edgeRightDiv.className = this.getClassName("flexlayout-edge-rect");
